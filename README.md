## Система сбора СМС с телеметрией с электрических подстанций
...
- *signal_PS*. Страница со списком доступных для пользователя подстанций с просмотром состояния сигналов, собираемых с выбранной подстанции
...
Данный модуль сохраняет принимаемые СМС в БД используя ORM систему Django и позволяет отправлять СМС-запросы на GSM-контроллеры установленные на подстанциях. Также модуль отвечает за дополнительное оповещение пользователей по СМС о не просмотренных сообщениях на главной странице за установленное время.
